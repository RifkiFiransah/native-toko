        ...
        <div class="container">
          ...
          <div class="sidebar mt-3">
            <ul class="list-unstyled mt-3">
              ...
              <li class="my-4 mx-3">
                <a href="front-end/barang.php" class="text-decoration-none text-secondary"><i class="fas fa-shopping-bag"></i> Barang</a>
              </li>
              <li class="my-4 mx-3">
                <a href="front-end/pesanan.php" class="text-decoration-none text-secondary"><i class="fas fa-tasks"></i> Pesanan</a>
              </li>
              <li class="my-4 mx-3">
                <a href="front-end/akun.php" class="text-decoration-none text-secondary"><i class="fas fa-cogs"></i> Akun</a>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div class="row mt-3">
                <div class="col-md-4">
                  <div class="card text-white bg-info mb-3 text-center" style="max-width: 18rem;">
                    <div class="card-header"><i class="fas fa-shopping-bag"></i> Data Barang</div>
                    <div class="card-body">
                      <?php
                ...
                <div class="col-md-4">
                  <div class="card text-white bg-warning mb-3 text-center" style="max-width: 18rem;">
                    <div class="card-header"><i class="fas fa-tasks"></i> Data Pesanan</div>
                    <div class="card-body">
                      <?php
                      $id_user = $_SESSION['id_user'];
                      $qry_pesanan = mysqli_query($conn, "SELECT * FROM tb_pesanan WHERE tb_pesanan.id_user='$id_user'");
